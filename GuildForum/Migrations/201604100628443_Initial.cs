    ...
    public partial class Initial : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.ID)
                .Index(t => t.SortOrder, unique: true);
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.Fora", t => t.Forum_ID1)
                .Index(t => t.ForumID)
                .Index(t => t.Forum_ID)
                .Index(t => t.Forum_ID1);
            ...
            CreateTable(
                ...
                c => new
                    {
                        Id = c.String(nullable: false, maxLength: 128),
                        Details_FirstName = c.String(),
                        Details_LastName = c.String(),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Threads", "Forum_ID1", "dbo.Fora");
            DropForeignKey("dbo.Threads", "Forum_ID", "dbo.Fora");
            DropForeignKey("dbo.ThreadReplies", "ThreadID", "dbo.Threads");
            DropForeignKey("dbo.Threads", "ForumID", "dbo.Fora");
            DropForeignKey("dbo.Fora", "ForumSectionID", "dbo.ForumSections");
            ...
            DropIndex("dbo.ForumSections", new[] { "SortOrder" });
            DropIndex("dbo.Fora", new[] { "ForumSectionID" });
